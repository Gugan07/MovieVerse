      ...
      <div className="bg-[#0f1218] border-b border-white/5 py-12">
        <div className="max-w-7xl mx-auto px-5">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-1 h-10 bg-[#e8a020] rounded-full mt-1" />
            <div>
              ...
              <p className="text-[#5a6472] text-sm mt-1">Search any film from TMDB's entire library</p>
            </div>
          </div>

          {/* ── Search bar — calls TMDB API ── */}
          <div className="relative max-w-lg mb-6">
            <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#4a5462]">🔍</span>
            <input
              type="text"
              value={query}
              onChange={e => setQuery(e.target.value)}
              placeholder="Search any film (e.g. Inception, RRR, Tamasha)…"
              className="w-full bg-[#131720] border border-white/8 text-white rounded-lg pl-10 pr-10 py-3 text-sm outline-none focus:border-[#e8a020] transition-colors placeholder-[#4a5462]"
            />
            {searchLoading && (
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded text-[11px] font-bold uppercase tracking-wider transition-all ${
                    selectedGenre === genre
                      ...
                      : 'bg-[#1a1e26] text-[#7a8694] hover:text-white border border-white/5 hover:border-white/15'
                  }`}
                >
                  {genre}
                </button>
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-black text-white uppercase tracking-widest">
                  ...
                  {!searchLoading && searchResults.length > 0 && (
                    <span className="text-[#4a5462] font-normal ml-2 text-xs normal-case tracking-normal">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#5a6472] text-[10px] uppercase tracking-widest">Live TMDB Search</span>
              </div>
            </div>
            ...
            {searchLoading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-[#5a6472] text-sm">Try a different spelling or search term</p>
              </div>
            ) : (
          ...
          <>
            ...
            {(selectedGenre === 'All' ||
              ...
              <div className="mb-12">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-sm font-black text-white uppercase tracking-widest">
                    Our Reviews
                    <span className="text-[#4a5462] font-normal ml-2 normal-case tracking-normal text-xs">
            ...
            <div>
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#e8a020] animate-pulse" />
                  <span className="text-[#5a6472] text-[10px] uppercase tracking-wider">Live TMDB</span>
                </div>
              </div>
